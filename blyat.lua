...
local Themes = {
    ["Dark"] = {
        Topbar = Color3.fromRGB(14, 0, 87),
        TabContainer = Color3.fromRGB(14, 0, 84),
        Lines = Color3.fromRGB(6, 0, 33),
        HoverTabFrame = Color3.fromRGB(6, 0, 33),
        ItemUIStroke = Color3.fromRGB(41, 41, 50),
        TabFrame = Color3.fromRGB(35, 35, 40),
        SectionFrame = Color3.fromRGB(30, 30, 35),
        TabText = Color3.fromRGB(94, 86, 214),
        ItemText = Color3.fromRGB(237, 237, 237),
        ItemUIStrokeSelected = Color3.fromRGB(85, 81, 207),
